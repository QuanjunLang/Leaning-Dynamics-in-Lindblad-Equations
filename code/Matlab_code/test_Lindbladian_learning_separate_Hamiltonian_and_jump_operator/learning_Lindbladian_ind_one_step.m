function C_est = learning_Lindbladian_ind_one_step(sysInfo, all_rho, H, C_other, C_ind_current)
...
for j = 1:niter
    ...
    % if j == 30
    const = mean(C_ind_1_est./C_ind_2_est', 'all');
    C_est = C_ind_1_est/sqrt(const);
